...
exports.create = (name, auth) => {
    ...
    fs.copySync(path.join(__dirname, './gitignore'), `${name}/.gitignore`);
    ...
    shell.exec('npm install express knex objection bcryptjs jsonwebtoken indicative@5.0.8 factory-girl factory-girl-objection-adapter @sendgrid/mail');
